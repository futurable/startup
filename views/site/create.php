...
<div class="site-index">
	...
	<div class="jumbotron">
        ...
        <div class="form-group" id='company-info'>
            ...
            <?php
            echo $form->field($company, 'industry_id')->dropDownList($industryArray, [
                'prompt' => "- " . Yii::t('Company', 'Select industry') . " -"
            ]);
            ?><br /> <label for='company-employees'><?php echo Yii::t('Company', 'Employees'); ?></label><br />
            <?php
            echo $form->field($company, 'employees')->dropDownList($employeeArray);
            ?><br />
		</div>
