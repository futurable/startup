...
return array (
  '(not set)' => '(ei asetettu)',
  'An internal server error occurred.' => 'Sisäinen virhe on tapahtunut',
  'Are you sure to delete this item?' => 'Oletko varma että haluat poistaa tämän?',
  'Delete' => 'Poista',
  'Error' => 'Virhe',
  'File upload failed.' => 'Tiedoston lataus palvelimelle epäonnistui',
  'Home' => '',
